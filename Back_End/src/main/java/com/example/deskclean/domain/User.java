...
public class User {
    ...
    private String email; // 사용자 이메일 (username과 동일할 수 있음)

    // 학교 인증 관련 필드
    @Column(nullable = false)
    @Builder.Default
    private Boolean schoolEmailVerified = false; // 학교 이메일 인증 여부

    private String schoolEmail; // 학교 이메일 (예: @o.shinhan.ac.kr)
}